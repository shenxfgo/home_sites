...
async def list_favorites(
    ...
    """Get favorite videos."""
    videos, total = await service.get_favorites(page=page, page_size=page_size)
...
async def add_favorite(
    ...
    try:
        await service.add_favorite(video_id)
...
async def remove_favorite(
    ...
    try:
        await service.remove_favorite(video_id)
    except ValueError as e:
...
async def check_favorite(
    ...
    is_fav = await service.is_favorite(video_id)
